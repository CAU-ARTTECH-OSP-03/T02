...
class game() :
        def _init_(self):
            ...
            import (self.result)
                ...
                fruits = ['star', 'trophy', 'wine', 'bomb']    #entities in the game
                ...
                def generate_random_fruits(fruit):
                    fruit_path = "images/" + "enfj/" fruit + ".png"
                         data[fruit] = {
                ...
                def show_gameover_screen():
                    ...
                    draw_text(gameDisplay, "MBTI NINJA!", 90, WIDTH / 2, HEIGHT / 4)
                    if not game_over :
                        ...
                        if value['throw']:
                            ...
                            if not value['hit'] and current_position[0] > value['x'] and current_position[0] < value['x']+60 \
                                ...
                                if player_lives < 0 :
                                    ...
                                    half_fruit_path = "images/sparkles.png"
                                else:
                                    half_fruit_path = "images/" + "sparkles.png"
                ...
                if self.result == 8:
                    ...
                    fruits = ['balloon', 'rainbow', 'smile', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "enfp/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 11:
                    ...
                    fruits = ['crown', 'globe', 'medal', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "entj/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 10:
                    ...
                    fruits = ['lightbulb', 'smile2', 'joker', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "entp/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 13:
                    ...
                    fruits = ['wine2', 'drinks', 'present', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "esfj/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 12:
                    ...
                    fruits = ['paperbag', 'highhills', 'firecracker', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "esfp/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 15:
                    ...
                    fruits = ['coffee', 'medal3', 'sound', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "estj/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 14:
                    ...
                    fruits = ['medal4', 'rugbyball', 'beer', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "estp/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 1:
                    ...
                    fruits = ['bud', 'telescope', 'violin', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "infj/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 0:
                    ...
                    fruits = ['heart', 'pinkheart', 'rainbow2', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "infp/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 3:
                    ...
                    fruits = ['glasses' , 'bat', 'dart', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "intj/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 2:
                    ...
                    fruits = ['book', 'game', 'scope', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "intp/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 5:
                    ...
                    fruits = ['bunny', 'heart', 'letter', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "isfj/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 4:
                    ...
                    fruits = ['palette', 'headphone', 'note', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "isfp/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 7:
                    # pixmap1.load('./cell/istj.png')
                    fruits = ['hat', 'set', 'news', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "istj/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
                ...
                if self.result == 6:
                    ...
                    fruits = ['knife', 'equip', 'ride', 'bomb']  # entities in the game
                    ...
                    # Generalized structure of the fruit Dictionary
                    def generate_random_fruits(fruit):
                        fruit_path = "images/" + "istp/" + fruit + ".png"
                        data[fruit] = {
                            'img': pygame.image.load(fruit_path),
                            'x': random.randint(100, 500),  # where the fruit should be positioned on x-coordinate
                            'y': 800,
